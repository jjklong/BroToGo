...
//   "use strict";
  ...
  //Used http://jsfiddle.net/5ucD3/461/ to help understand this animation method
    ...
    if(request == "who are you?".toLowerCase() ){
     ...
     if(request == 'what are you?'.toLowerCase()  ){
     ...
     if(request.match(/thirsty/g) == 'thirsty'.toLowerCase()  ){
    ...
    if(request.match(/thank/g) == "thank".toLowerCase()  ){
     setTimeout(function travBotreply4(){
       $('#chatbox').append('<li class="bot">' + " No worries friend. "+ '</li>');
     }, 1000);
   }
   if(request.match(/music/g) == "music".toLowerCase()  ){
  ...
  if(request.match(/hello/g) == "hello".toLowerCase()  ){
